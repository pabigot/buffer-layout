 ...
 * Union#default_layout|discr_layout}.
 *
 * @param {string} [property] - initializer for {@link
 * Layout#property|property}.
 *
...
function Union (discr_layout,
    ...
    var layout = new Structure([discr_layout.replicate('variant'),
                                default_layout.replicate('content')]);
    Layout.call(this, layout.span, property);

    /** The layout for unrecognized variants.
     *
     * This is a {@link Structure|Structure} layout where the {@link
     * Union#discr_layout|discriminator} is represented by the
     * property named `variant` and the property `content` is decoded
     * using the {@link Union#default_layout|default layout}. */
    this.layout = layout;

    /** The layout for the discriminator value in isolation.
     *
     * In unrecognized variants this is returned as the `variant`
     * property of an object. */
    this.discr_layout = discr_layout;

    /** The layout used content when the value of the discriminator is
     * not recognized.
     *
     * In unrecognized variants this is returned as the `content`
     * property of an object. */
